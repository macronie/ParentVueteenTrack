...
// MYPHP
    class MYPHP
    {
        ...
        public static $friends_array = array();
        ...
        public static function init($path)
        {
            ...
            {
                trigger_error("MYPHP Library is already initialized", E_USER_ERROR);
            }
        ...
        public static function query(/* $sql [, ... ] */)
        {
            ...
            if (!isset(self::$config))
            {
                trigger_error("MYPHP Library is not initialized", E_USER_ERROR);
            }
